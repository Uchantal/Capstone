...
export default function GDLevel3PractisePage() {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-white">
      ...
      <AskAIHint discipline="Graphic Design" context="Graphic Design Level 3 — Practise (practise combining hierarchy, contrast, and balance in one composition)" side="left" />
    </div>
  )
}
